<?php  //[STAMP] 795c39d6efebcc5bfc8d9a994f7c92d4
...
trait ApiTesterActions
{
     ...
     *
     *
     * @see \Helper\Api::checkOperationStatusSuccess()
     */
    public function checkOperationStatusSuccess($resp_code) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('checkOperationStatusSuccess', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Api::checkMessageContainsRequiredFieldName()
     */
    public function checkMessageContainsRequiredFieldName($absent_fields) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('checkMessageContainsRequiredFieldName', func_get_args()));
    }
}
